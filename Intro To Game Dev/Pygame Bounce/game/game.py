...
class VideoGame:
    ...
    def __init__(
            self, window_width=700, window_height=700, window_title="My Awesome Game"
    ):
...
class BounceDemo(VideoGame):
    ...
    def build_scene_graph(self):
        ...
        credits_string = 'Sound Effects: Monkey.aiff and Boing.aiff from Mac OS 7. \
            Soundtrack: Jack Pearcy, "Warm Rays, Good Waves", Deep Lake Records. \
